...
class MunicipalityMap extends Component {
  ...
  toggleIntro = (event) => {
    this.props.toggleIntro(event.target.className);
  }
    ...
    return (
      <div className="map-page">
        ...
        <map name="Map2" id="Map2">
            ...
            <area onClick={this.toggleIntro} shape="poly" alt="" coords="8,196,76,176,67,184,66,191,72,199,80,203,88,207,96,212,101,218,107,216,116,214,117,220,117,230,125,238,131,239,131,247,126,258,131,266,111,278,101,290,90,311,80,336,70,348,62,353,6,220" className="w10"/>
            <area onClick={this.toggleIntro}shape="poly" alt="" coords="83,175,230,128,240,199,244,201,250,202,254,207,247,212,249,222,253,229,244,238,191,256,174,259,148,260,137,266,131,254,138,241,138,234,134,230,128,231,122,218,115,211,105,205,98,207,83,191,75,184" className="w05"/>
            <area onClick={this.toggleIntro}shape="poly" alt="" coords="239,126,301,107,317,188,284,221,280,190,292,181,286,181,273,170,260,154,246,150,255,140" className="c07"/>
