...
class MunicipalityMap extends Component {
  ...
  munSelect = (event) => {
    this.props.munSelect(event.target.id, event.target.className);
  }
    ...
    return (
      <div className="map-page">
        ...
        <map name="Map2" id="Map2">
            ...
            <area id="1" onClick={this.munSelect} shape="poly" alt="" coords="305,106,322,187,333,172,348,169,335,97" className="c14"/>
            ...
            <area id="3" onClick={this.munSelect} shape="poly" alt="" coords="265,381,349,357,365,404,369,411,357,420,349,427,358,435,375,438,396,425,402,431,388,454,368,475,349,475,316,443,299,442,300,427,307,422,309,409,299,405,280,398" className="c01"/>
            ...
            <area id="2" onClick={this.munSelect} shape="poly" alt="" coords="204,400,259,385,275,402,298,416,301,419,286,425,291,436,252,429,236,428,230,421,220,412,214,410,208,405" className="w01"/>
